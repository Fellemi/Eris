...
function changeText(value) {
    ...
    if (value == 1) text += "Mercury is a planet. Our smallest planet even. Poor one, doesn't have any moons and is therefore not in my interest at all.";
    ...
    if (value == 5) text += "Jupiter is our solar system's largest planet, and has a mass of similar components of a star. It's also home to the Galilean moons, which are the coolest celestial bodies ever.";
